          ...
          <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={validationSchema}>
              {(props) => (
                <Form>
                  ...
                  <Field as={TextField} label='product_price' name='product_price' type="number" InputProps={{inputProps: {max: 10000, min: 0}}} placeholder='Enter price' style={textFieldStyle} fullWidth required helperText={<ErrorMessage name="product_price"/>}/>
                  <Field as={TextField} label='inventory' name='inventory' type="number" InputProps={{inputProps: {max: 10000, min: 0}}} placeholder='Enter how many to list' style={textFieldStyle} type="number" fullWidth required helperText={<ErrorMessage name="inventory"/>}/>
